...
import modoo.funding.back.vo.RegisterReq;
...
/*			if(result != -1) {
    ...
    public String encSHA256 (String password) throws Exception {
		 ...
		 * 
		 * @SuppressWarnings("restriction") sun.misc.BASE64Encoder encoder = new
		 * sun.misc.BASE64Encoder();
		 * 
		 * @SuppressWarnings("restriction") String str = encoder.encode(mdResult);
		 */
    	  return password;  
      }
