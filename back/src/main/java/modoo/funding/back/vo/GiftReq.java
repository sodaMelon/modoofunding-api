...
public class GiftReq {
	private String min_price1;
	private String gift_name1;
	private String min_price2;
	private String gift_name2;
	private String min_price3;
	private String gift_name3;

	public String getMin_price1() {
		return min_price1;
	}

	public void setMin_price1(String min_price1) {
	...
	public String getMin_price3() {
		return min_price3;
	}

	public void setMin_price3(String min_price3) {
